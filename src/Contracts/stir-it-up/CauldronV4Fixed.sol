...
contract CauldronV4Fixed is BoringOwnable, IMasterContract {
    ...
    CauldronV4Fixed public immutable masterContract;
    ...
    constructor(address bentoBox_, address magicInternetMoney_) {
        bentoBox = IBentoBoxV1(bentoBox_);
        magicInternetMoney = IERC20(magicInternetMoney_);
        masterContract = this;
